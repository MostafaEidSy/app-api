                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control" required="required" value="{{old('name', $article->name)}}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="content_articles" id="content_articles" class="form-control">{{old('content_articles', $article->content)}}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="slug" id="slug" class="form-control" required="required" placeholder="ex: article-slug" value="{{old('slug', $article->slug)}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control">
                                    <option value="1" @if($article->status == 1) selected @endif>Publishing</option>
