    ...
    <section class="create-articles">
        ...
        <div class="body">
            <div class="form">
                ...
                <form action="{{route('admin.articles.story')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="slug" id="slug" class="form-control" required="required" placeholder="ex: article-slug" value="{{old('slug')}}">
