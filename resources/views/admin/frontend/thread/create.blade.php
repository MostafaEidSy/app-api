...
@section('content')
    <section class="create-thread">
        ...
        <div class="body">
            <form method="post" action="{{route('admin.thread.story')}}">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12 details" id="details">
                        <div class="row detail-row add-row" id="0">
                            <div class="col-md-1">
                                <div class="button">
                                    #
                                </div>
                            ...
                            <div class="col-md-11">
                                <div class="form-group">
                                    <input type="text" name="detail[]" id="detail" required="required" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
